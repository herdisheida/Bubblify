    ...
    <div className="p-10">
      <h1 className="text-3xl mb-6">Delivery Method</h1>
        ...
        */}
        ...
        <button className="bg-sky-500 hover:bg-sky-700 text-white px-6 py-3 rounded mt-4 mr-4 transition-colors cursor-pointer"
          onClick={() => handleSelect(pickup)}>
            Store Pickup
        </button>

        <button className="bg-sky-500 hover:bg-sky-700 text-white px-6 py-3 rounded mt-4 ml-4 transition-colors cursor-pointer"
